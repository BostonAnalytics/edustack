...
Your browser will automatically refresh as you edit pages.

Screenshot placeholder: Local preview in browser

## Create the Module Structure

Add a folder for the first module:
...
This page introduces the module structure and learning goals.
```
  ...
  navbar:
    left:
      ...
      - text: About
        href: about.qmd
      - text: Module 1
        href: module1/module1_overview.qmd
```

Screenshot placeholder: Folder tree with module1 folder
...
Screenshot placeholder: custom.scss in editor

Actual styling will be introduced later once the structure is stable.
