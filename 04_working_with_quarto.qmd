...
# Reproducible Documents, Research, and Software
...
:::: {.columns}
::: {.column width="50%"}
![LaTex math for undergrads [[link](http://tug.ctan.org/info/undergradmath/undergradmath.pdf)]](lecture00_figures/pdf.png)
:::

::: {.column width="50%"}
![LaTex math for undergrads [[link](http://tug.ctan.org/info/undergradmath/undergradmath.pdf)]](lecture00_figures/eqn.png)
:::
::::
...
* Mathpix is a tool that uses optical character recognition to convert images of handwritten or printed math equations into digital formats, aiding quick integration of math content into documents and applications.
    ![](lecture00_figures/2023-08-24-09-24-28.png){width=800}
...
:::: {.columns}
::: {.column width="30%"}
![](lecture00_figures/rmarkdown.png){width=300}
:::
...
:::: {.columns}
::: {.column width="40%"}
![](lecture00_figures/pandoc.png){height=55%}
:::
::: {.column width="60%"}
...
![Andrew Bray, rstudio::conf(2022)](lecture00_figures/paste-00475E59.png)
...
:::
::: {.column width="40%"}
![Source: jupyter.org](lecture00_figures/jupyter.png)
:::
::::
...
:::: {.columns}
::: {.column width="30%"}
![](lecture00_figures/2egqlc.jpeg){height=350}

:::
::: {.column width="70%"}
<!-- ![](lecture00_figures/grus-jupyter.png){width=250} -->
...
![](lecture00_figures/quarto_logo.svg){width=20% fig-align="center"}
::::
...
![](lecture00_figures/RStudio_logo.svg){width=30% fig-align="center"}
...
![](lecture00_figures/jupyter_logo.svg){width=30% fig-align="center"}
...
::: {.r-stack}
:::{.fragment .fade-left}
![&nbsp;](lecture00_figures/paste-0860D360.png){fig-align="center" width="65%"}
:::
:::{.fragment .fade-right}
![&nbsp;](lecture00_figures/paste-CC007B93.png){.fragment .fade-left fig-align="center" width="65%"}
:::
:::
...
![](lecture00_figures/quarto-steps.png){width="80%" fig-align="center"}
...
![](lecture00_figures/paste-CC007B93.png){fig-align="left" width="3.00in"}

![](lecture00_figures/paste-0860D360.png){fig-align="left" width="3.00in"}
...
````
::: {layout="[[1], [1], [1],[1]]"}
![](lecture00_figures/pdf.png){width=250}
![](lecture00_figures/eqn.png){width=250}
![](lecture00_figures/paste-0860D360.png){width=250}
![](lecture00_figures/paste-0860D360.png){width=250}
:::
````
...
* The following VSC extension allows you to paste images from the clip-board with `alt+command+v`.    
    ![](lecture00_figures/2023-08-23-09-35-05.png){width=300}
...
![](lecture00_figures/citations.png)
...
![American Statistical Association](lecture00_figures/asa.png)

![Nature](lecture00_figures/nature.png)

![Chicago](lecture00_figures/chicago.png)
...
::: {layout-ncol=2 }
![](lecture00_figures/snippets1.png){width="60%" fig-align="center"} 

![](lecture00_figures/snippets2.png){width="80%" fig-align="center"}
